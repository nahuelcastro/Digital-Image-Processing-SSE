...
.cicloHeight:           ; i
    ...
    .fin1:
        ...
        ; xor r11, r11
        ; mov dword r11d, x1_row_bits
        ; movdqu xmm12, [rsi + r11]
        ; xor r11, r11
        ; mov dword r11d, x2_row_bits
        ; movdqu xmm13, [rsi + r11]
        ; xor r11, r11
        ; mov dword r11d, x3_row_bits
        ; movdqu xmm14, [rsi + r11]

        ; movdqu xmm15, mask_clean_dst
        ; pand xmm11, mask_clean_dst                  ; xmm11 :  [  0 | px2 | px1 | px0 ]
        ; pand xmm12, mask_clean_dst
        ; pand xmm13, mask_clean_dst
        ; pand xmm14, mask_clean_dst
        ...
        ; pand xmm5, mask_clean_1                     ; xmm5 :  [  px_res0 | 0 | 0 | 0 ]
        ; pand xmm6, mask_clean_1                     ; xmm6 :  [  px_res1 | 0 | 0 | 0 ]
        ; pand xmm7, mask_clean_1
        ; pand xmm8, mask_clean_1
